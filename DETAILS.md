...
Email the developers privately with the details of the issue.

For code issues
We would strongly prefer if you create a pull request on GitHub in the proper repository with the necessary fix (along with your Bitcoin address to claim the bounty). For more information, see this link. 

For website issues
Please contact support with the error, along with your Bitcoin address.
...
Bounties will be confirmed and awarded within 10 days of their reporting. Inquiries on bounty status may be sent to bounties@counterparty.io
